...
def initWorkflow():
    ...
    if not path.exists("config.json"):
        ...
        def completeWorkflow(k):
            ...
            shutil.copyfile(__file__,"KeyboardAssist.pyw") # Adds program to startup
            SWinLnk().create_lnk(path.join(path.dirname(__file__),"KeyboardAssist.pyw"),lnk_path+"\KeyboardAssist.lnk")
